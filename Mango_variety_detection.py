...
train_dataset = train.flow_from_directory(
    r"C:\Users\Avantika\PycharmProjects\miniproject_DIP_04_09\Training",
    target_size=(224, 224),
    batch_size=9,
...
validation_dataset = validation.flow_from_directory(
    r"C:\Users\Avantika\PycharmProjects\miniproject_DIP_04_09\Validation",
    target_size=(224, 224),
    batch_size=9,
    class_mode='categorical'
)
...
img = image.load_img(r"C:\Users\Avantika\PycharmProjects\miniproject_DIP_04_09\Testing\Hapus_Mango\Hapus (30).jpg", target_size=(224, 224))
plt.imshow(img)
plt.show()
...
# Mapping the class indices to mango varieties
class_indices = train_dataset.class_indices
index_to_class = {v: k for k, v in class_indices.items()}  # Reverse the dictionary to map index to class

predicted_variety = index_to_class[val]
print(f"The predicted mango variety is: {predicted_variety}")
